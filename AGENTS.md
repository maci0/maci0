...
- **A win in one metric is not acceptance.** Lower CPU with worse fidelity is a regression, and any regression past a few percent needs an explanation, not a merge.
